...
CAF_BEGIN_TYPE_ID_BLOCK(vast_atoms, caf::id_block::vast_types::end)
  ...
  VAST_ADD_ATOM(metrics, "metrics")
  VAST_ADD_ATOM(mmap, "mmap")
  VAST_ADD_ATOM(move, "move")
  VAST_ADD_ATOM(normalize, "normalize")
  ...
  VAST_ADD_ATOM(rebuild, "rebuild")
  VAST_ADD_ATOM(receive, "receive")
